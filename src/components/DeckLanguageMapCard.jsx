...
class DeckLanguageMapCard extends Component {
    ...
    componentDidUpdate(oldProps) {
        ...
        let colorIndexPolygon = am5.color(0x0000FF);
    ...
    render() {
      return (   
        ...
        <div className="language-map-classic">  
...
export default DeckLanguageMapCard